...
//		User saveAndFlush = userAuthenticationRepository.saveAndFlush(user);
...
//		try {
//			boolean b = userAuthenticationRepository.existsById(user.getUserId());
//
...
//		}
		...
		if(!userAuthenticationRepository.findById(user.getUserId()).isPresent()) {
