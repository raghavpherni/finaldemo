...
public class NoteController {
	...
	public ResponseEntity<String> delete(@PathVariable String userId, @PathVariable int noteId) {
		boolean deleteNote = noteService.deleteNote(userId, noteId);
		if (deleteNote) {
	...
	public ResponseEntity<?> update(@PathVariable String userId, @PathVariable int noteId) {

		Note noteByNoteId;

		Note updateNote;
		try {
			noteByNoteId = noteService.getNoteByNoteId(userId, noteId);
			updateNote = noteService.updateNote(noteByNoteId, noteId, userId);
			if (updateNote != null) {
	...
	public ResponseEntity<List<Note>> getAllNotes(@PathVariable String userId) {
		...
		list = noteService.getAllNoteByUserId(userId);
		//if (list!=null) {
	...
	public ResponseEntity<String> deleteAll(@PathVariable String userId) {
		boolean deleteNote;
		try {
			deleteNote = noteService.deleteAllNotes(userId);
			if (deleteNote) {
