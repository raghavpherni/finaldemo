...
public class ReminderController {
	...
	public ResponseEntity<?> createReimder(@RequestBody Reminder reminder) {
	...
	public ResponseEntity<String> deleteReimder(@PathVariable String id) {
	...
	public ResponseEntity<?> updateReimder(@RequestBody Reminder reminder, @PathVariable String id) {
	...
	public ResponseEntity<?> getAllReminder() {
		...
		try {
			allReminders = reminderService.getAllReminders();
